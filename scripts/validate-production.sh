...
run_gate "Gate 05: Security & Adversarial Attack Verification" "cargo test -p kubelab-api --test security_adversarial_test"
...
run_gate "Gate 13: Infrastructure Lifecycles & Container Configs" "[ -f '$ROOT/infrastructure/containers/podman-compose.yml' ] && [ -f '$ROOT/scripts/lab-up.sh' ]"
