...
run_gate "Gate 05: Web Application, Playwright E2E & WCAG Specs" "[ -f '$ROOT/apps/web/src/app/page.tsx' ] && [ -f '$ROOT/apps/web/e2e/full-journey.spec.ts' ] && [ -f '$ROOT/apps/web/e2e/wcag-accessibility.spec.ts' ]"
